...
import type { Client, ClientAccount, ClientAvatarPreset } from '@/types/client';
    ...
    <AppScreen contentStyle={styles.content} bottomTabInset={false} keyboardAvoiding>
      <AppCard style={styles.form}>
        ...
        <AppTextField
          ...
          secureTextEntry
        />
        <Field label="Avatar predefinito">
          <View style={styles.avatarChoiceRow}>
            <UserAvatar firstName={fullName} preset={avatarPreset} size={52} />
