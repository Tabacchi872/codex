...
const COVERAGE_EXERCISES: SeedExercise[] = [
  ...
  catalogSeed('spalle-shoulder-press-macchina', 'Shoulder press macchina', 'spalle', 'Spinta sopra la testa su macchina guidata, seduti con schienale in appoggio.', 'Traiettoria guidata dalla macchina, schiena in appoggio contro lo schienale, non bloccare i gomiti in alto.', 'beginner', 'Macchina shoulder press', { nameEn: 'Machine shoulder press', secondaryMuscleGroups: ['tricipiti'] }),
  ...
  catalogSeed('tricipiti-dip-ginocchia-piegate', 'Dip su sedia (ginocchia piegate)', 'tricipiti', 'Dip su sedia o panca stabile con ginocchia piegate e piedi vicini al corpo, per ridurre il carico rispetto al dip a gambe tese.', 'Busto il più verticale possibile, gomiti che puntano indietro, avvicinare i piedi per aumentare la difficoltà quando pronto.', 'beginner', 'Sedia o panca stabile', { nameEn: 'Bent-knee bench dip', aliases: ['Chair dip'], secondaryMuscleGroups: ['petto', 'spalle'] }),
