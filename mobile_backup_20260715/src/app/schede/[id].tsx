...
import { AppCard, BackHeader } from '@/components/ui';
...
export default function SchedaDettaglioScreen() {
  ...
  return (
    ...
    <ScrollView
      ...
      <BackHeader title={plan.name} fallbackHref={(isCoach ? '/schede' : '/workout') as Href} />
        ...
        <>
          ...
          <AppCard style={styles.detailHero}>
            <View style={styles.heroTop}>
              ...
              <View style={[styles.heroVisual, { borderColor: theme.border, backgroundColor: theme.backgroundElement }]}>
            ...
            <View style={styles.heroMetaGrid}>
              ...
              <HeroMeta label="Scadenza" value={plan.expiryDate} />
              {!isCoach ? <HeroMeta label="Completati" value={`${exerciseProgress.completed}/${exerciseProgress.total}`} /> : null}
            </View>
            {!isCoach ? (
              <View style={[styles.heroProgressTrack, { backgroundColor: theme.backgroundElement }]}>
                <View
                  style={[
