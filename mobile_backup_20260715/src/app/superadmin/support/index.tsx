...
import { AppCard, AppPressableCard } from '@/components/ui';
...
function ConversationCard({ conversation, onPress }: { conversation: SuperadminSupportConversation; onPress: () => void }) {
  ...
  return (
    <AppPressableCard
      onPress={onPress}
      accessibilityLabel={`Apri supporto coach ${conversation.coach.name}`}
      style={[styles.card, { borderColor: conversation.unreadCount > 0 ? colors.coral : colors.border }]}>
