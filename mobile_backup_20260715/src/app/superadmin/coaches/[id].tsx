...
import { AppBadge, AppButton, AppCard, AppTextField, BackHeader, type AppBadgeTone } from '@/components/ui';
...
export default function SuperadminCoachDetail() {
  ...
  return (
    <SuperadminShell title={coach.name} description="Dettaglio coach con modifica manuale e clienti associati.">
      <BackHeader title={coach.name} fallbackHref="/superadmin/coaches" />
      <AppCard style={styles.card}>
