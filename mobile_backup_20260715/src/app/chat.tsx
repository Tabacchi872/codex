...
import { AppButton, AppCard, AppEmptyState, AppIconButton, AppPressableCard, AppTextField } from '@/components/ui';
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <FlatList
        ...
        renderItem={({ item }) => (
          <AppPressableCard
            onPress={() => onSelect(item.client.id)}
            accessibilityLabel={`Apri conversazione con ${clientFullName(item.client)}`}
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <FlatList
        ...
        renderItem={({ item }) => (
          <AppPressableCard onPress={() => onSelect(item.id)} accessibilityLabel={`Apri conversazione con ${clientFullName(item)}`} style={styles.clientCard}>
